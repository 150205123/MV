const claveRegistros = 'registrosArchivo3'; 
...
function agregarRegistro() {
    ...
    if (numero && area && descripcion && proveedor && responsable && fechaVencimiento && observacion) {
        ...
        document.getElementById("area").value = 'ADMINISTRACION';
        document.getElementById("descripcion").value = '';
        document.getElementById("proveedor").value = '';
        document.getElementById("responsable").value = 'ISMAEL RIVAS';
...
function exportarExcel() {
    ...
    XLSX.writeFile(wb, "registrosdetopico.xlsx");
}
