const claveRegistros = 'registrosArchivo5'; 
...
function agregarRegistro() {
   ...
   if (numero && area && descripcion && proveedor && responsable && fechaVencimiento && observacion) {
       ...
       document.getElementById("area").value = 'AMP';
       document.getElementById("descripcion").value = '';
       document.getElementById("proveedor").value = '';
       document.getElementById("responsable").value = 'DANIEL ROJAS';
...
function exportarExcel() {
   ...
   XLSX.writeFile(wb, "registrosdeamp.xlsx");
}