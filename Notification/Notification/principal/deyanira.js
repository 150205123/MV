const claveRegistros = 'registrosArchivo4'; 
...
function agregarRegistro() {
    ...
    if (numero && area && descripcion && proveedor && responsable && fechaVencimiento && observacion) {
        ...
        document.getElementById("area").value = 'LABORATORIO';
        document.getElementById("descripcion").value = '';
        document.getElementById("proveedor").value = '';
        document.getElementById("responsable").value = 'DEYANIRA TORRES';
...
function exportarExcel() {
    ...
    XLSX.writeFile(wb, "registrosdelaboratorio.xlsx");
}
